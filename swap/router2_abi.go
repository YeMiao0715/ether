...
func (i *IRouter2) Method(fn string, param ...interface{}) ([]byte, error) {
...
func (i *IRouter2) WETH() ([]byte, error) {
	return i.Method("WETH")
}

func (i *IRouter2) UnpackWETH(data []byte) (common.Address, error) {
...
func (i *IRouter2) Factory() ([]byte, error) {
	return i.Method("factory")
}

func (i *IRouter2) UnpackFactory(data []byte) (common.Address, error) {
...
func (i *IRouter2) AddLiquidityETH(
...
func (i *IRouter2) RemoveLiquidity(
	tokenA,
	tokenB common.Address,
	liquidity,
	amountAMin,
...
func (i *IRouter2) RemoveLiquidityETH(
	token common.Address,
	liquidity,
	amountTokenMin,
	amountETHMin *big.Int,
...
func (i *IRouter2) RemoveLiquidityWithPermit(
	tokenA,
	tokenB common.Address,
	liquidity,
	amountAMin,
...
func (i *IRouter2) RemoveLiquidityETHWithPermit(
	token common.Address,
	liquidity,
	amountTokenMin,
	amountETHMin *big.Int,
...
func (i *IRouter2) SwapExactTokensForTokens(
	amountIn,
...
func (i *IRouter2) SwapTokensForExactTokens(
	amountOut,
	amountInMax *big.Int,
	path []common.Address,
	to common.Address,
...
func (i *IRouter2) SwapExactETHForTokens(
	amountOutMin *big.Int,
	path []common.Address,
	to common.Address,
	deadline *big.Int,
...
func (i *IRouter2) SwapTokensForExactETH(
	amountOut,
	amountInMax *big.Int,
	path []common.Address,
	to common.Address,
...
func (i *IRouter2) SwapExactTokensForETH(
	amountIn,
	amountOutMin *big.Int,
	path []common.Address,
	to common.Address,
...
func (i *IRouter2) SwapETHForExactTokens(
	amountOut *big.Int,
	path []common.Address,
	to common.Address,
	deadline *big.Int,
...
func (i *IRouter2) Quote(amountA, reserveA, reserveB *big.Int) ([]byte, error) {
	return i.Method("quote", amountA, reserveA, reserveB)
}

func (i *IRouter2) UnpackQuote(data []byte) (*big.Int, error) {
...
func (i *IRouter2) GetAmountOut(amountIn, reserveIn, reserveOut *big.Int) ([]byte, error) {
	return i.Method("getAmountOut", amountIn, reserveIn, reserveOut)
}

func (i *IRouter2) UnpackGetAmountOut(data []byte) (*big.Int, error) {
...
func (i *IRouter2) GetAmountIn(amountOut, reserveIn, reserveOut *big.Int) ([]byte, error) {
	return i.Method("getAmountIn", amountOut, reserveIn, reserveOut)
}

func (i *IRouter2) UnpackGetAmountIn(data []byte) (*big.Int, error) {
...
func (i *IRouter2) GetAmountsOut(amountIn *big.Int, path []common.Address) ([]byte, error) {
	return i.Method("getAmountsOut", amountIn, path)
}

func (i *IRouter2) UnpackGetAmountsOut(data []byte) (amounts []*big.Int, err error) {
...
func (i *IRouter2) GetAmountsIn(amountOut *big.Int, path []common.Address) ([]byte, error) {
	return i.Method("getAmountsIn", amountOut, path)
}

func (i *IRouter2) UnpackGetAmountsIn(data []byte) (amounts []*big.Int, err error) {
	amounts = make([]*big.Int, 0)
