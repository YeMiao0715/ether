...
type IPoolAbi struct {
	abi *abi.ABI
}

func (i *IPoolAbi) GetAbi() (*abi.ABI, error) {
	if i.abi == nil {
...
func (i *IPoolAbi) Method(fn string, param ...interface{}) ([]byte, error) {
...
func (i *IPoolAbi) MustAbi() *abi.ABI {
	abi, _ := i.GetAbi()
	return abi
}

func (i *IPoolAbi) Slot0() ([]byte, error) {
	return i.Method("slot0")
}

func (i *IPoolAbi) UnpackSlot0(data []byte) (*Slot0, error) {
...
func (i *IPoolAbi) Token0() ([]byte, error) {
	return i.Method("token0")
}

func (i *IPoolAbi) UnpackToken0(data []byte) (common.Address, error) {
...
func (i *IPoolAbi) Token1() ([]byte, error) {
	return i.Method("token1")
}

func (i *IPoolAbi) UnpackToken1(data []byte) (common.Address, error) {
...
func (i *IPoolAbi) Mint(recipient common.Address, tickLower, tickUpper, amount *big.Int) ([]byte, error) {
	return i.Method("mint", recipient, tickLower, tickUpper, amount)
}

func (i *IPoolAbi) UnpackMint(data []byte) (*big.Int, *big.Int, error) {
